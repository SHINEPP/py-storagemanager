...
class ImageFeatures:
    ...
    def __init__(self):
        # 加载 TFLite 模型
        model_path = 'mobilenet-v3-tensorflow2-large-075-224-classification-v1.tflite'
    ...
    def extract_features(self, image_path):
        ...
        img = tf.keras.applications.mobilenet_v3.preprocess_input(img)  # 预处理图片
        ...
        decoded_predictions = tf.keras.applications.mobilenet_v3.decode_predictions(feature_vector, top=3)[0]
        # 打印前3个预测结果
