...
AND json_extract(event_parameters, '$.app_version')  = '11'
AND event_date_utc >= '2025-03-10' AND event_date_utc <= '2025-03-19'
...
LIMIT 0, 2000
    ...
    with open_analytics() as cursor:
        ...
        out_path = f'/Users/zhouzhenliang/Desktop/temp-analytics/{app_name}_events_funnel_2.0_{date_text}.csv'
